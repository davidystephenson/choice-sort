...
__export(index_exports, {
  ...
  operationDefSchema: () => operationDefSchema,
...
// src/createUid.ts
var import_rand_seed = __toESM(require("rand-seed"));
function createUid(props) {
  const seedString = `${props.uid}-${props.count}`;
  const rand = new import_rand_seed.default(seedString);
...
var choiceSchema = import_zod.z.object({
  catalog: import_zod.z.string(),
  operation: import_zod.z.string(),
  queue: import_zod.z.string()
});
var operationSchema = import_zod.z.object({
  better: import_zod.z.number().optional(),
  catalog: import_zod.z.array(import_zod.z.string()),
  output: import_zod.z.array(import_zod.z.string()),
  queue: import_zod.z.array(import_zod.z.string()),
  uid: import_zod.z.string()
});
var operationDefSchema = import_zod.z.object({
  catalog: import_zod.z.array(import_zod.z.string()),
  queue: import_zod.z.array(import_zod.z.string()),
  output: import_zod.z.array(import_zod.z.string())
});
var flowSchema = import_zod.z.object({
  count: import_zod.z.number(),
  items: import_zod.z.record(import_zod.z.string(), itemSchema),
  operations: import_zod.z.record(import_zod.z.string(), operationSchema),
  uid: import_zod.z.string()
});
var rankingItemSpecificSchema = import_zod.z.object({
